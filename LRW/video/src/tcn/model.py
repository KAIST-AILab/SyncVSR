...
import math
import numpy as np
from tcn.models.resnet import ResNet, BasicBlock
from tcn.models.resnet1D import ResNet1D, BasicBlock1D
from tcn.models.tcn import MultibranchTemporalConvNet, TemporalConvNet
from tcn.models.densetcn import DenseTemporalConvNet
from tcn.models.swish import Swish
...
def _average_batch(x, lengths, B):
    # x : (32, 1664, 29)
    # x[0] : (1664, 29)
    # torch.mean(x[0][:,0:29], 1) ->  len(lengths) : batch_size, lengths[i] : time_size
